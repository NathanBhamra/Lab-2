...
rectangle::rectangle(sf::Vector2f a, sf::Vector2f b, sf::Vector2f c, sf::Vector2f d, sf::Vector2f e) : Shape(5) { //Using the function which was defined in the header with a constructor to define what a and b... classes are.
	...
	drawRectangle(); //This is going to run the draw function
}

void rectangle::drawRectangle() { //Running the draw function
	points[0].position = point1;  // Stating the position of the point using an array called points
	points[0].color = sf::Color::Magenta; // Stating the colour of the point using an array called points
